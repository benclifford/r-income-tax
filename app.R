...
# GUI controls
      sliderInput("maxincome", "Maximum income:", min = 0, max = 1000000, value = 200000),
...
# Income tax
      ...
      sliderInput("personal_allowance_withdrawl_unit", "Personal allowance withdrawl unit:", min = 0, max = 20, value = realparam$personal_allowance_withdrawl_unit),
